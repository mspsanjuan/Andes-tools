...
export class TipoPrestacionService {
    ...
    /**
     * Metodo patch. Actualiza una propiedad del objeto tipoPrestacion.
     * @param {ITipoPrestacion} tipoPrestacion Recibe ITipoPrestacion
     */
    patch(tipoPrestacion: ITipoPrestacion, options: {op: String, data: any}): Observable<ITipoPrestacion> {
        return this.server.patch(this.tipoPrestacionUrl + '/' + tipoPrestacion.id, options);
    }
